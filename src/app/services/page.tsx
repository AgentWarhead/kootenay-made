...
import {
  ArrowRight, Check, Sparkle, Globe, Storefront, Robot, CastleTurret, ArrowsClockwise,
  MagnifyingGlass, Plant, Mountains, Lightning, PaintBrush, Crown, TShirt, ChatCircleDots,
  Shield, Rocket, Code, CurrencyDollar, GraduationCap, Handshake,
  VideoCamera, Wrench, ChartLineUp, UsersThree, GameController,
  ChatCircle, PencilSimple, CalendarBlank,
...
const packages = [
  ...
  },
  {
    ...
    featuresFull: [
      ...
      'AI business tools setup (GPT Codex)',
  ...
  },
  {
    ...
    price: '$2,000',
    priceNote: 'GPT Codex subscription: ~$20–$200 USD/mo',
    monthlyHint: null,
    ...
    featuresFull: [
      'GPT Codex configured for your business',
  ...
  },
  {
    ...
    description: 'We install and configure OpenClaw — an always-on AI assistant that lives on your phone, answers customer questions, manages your inbox, handles scheduling, and automates the busywork that eats your day. It works through WhatsApp, Telegram, or Discord — no app to download. Lifetime access to the Neighbours Dashboard included.',
    featuresShort: [
      ...
      'Works through WhatsApp, Telegram, or Discord',
    ...
    featuresFull: [
      ...
      'AI model configuration (GPT Codex — optimized for your needs)',
    ...
    popular: false,
    runningCosts: {
      basic: { label: 'Basic Use', monthly: '~$30–$50/mo', breakdown: 'VPS hosting (~$7–$15/mo) + OpenAI API (~$20/mo USD)' },
      advanced: { label: 'Advanced Use', monthly: '~$80–$160/mo', breakdown: 'VPS hosting (~$15–$25/mo) + OpenAI Pro ($200/mo USD) + optional integrations' },
    },
  },
  {
    id: 'empire',
...
function AIPackageCard({ variant }: { variant: 'advantage' | 'assistant' }) {
  ...
  const advantageData = {
    ...
    priceNote: 'GPT Codex subscription: ~$20–$200 USD/mo',
    tagline: 'AI that actually works for your business.',
    description: 'We set up GPT Codex as your personal business tool — trained on your services, your processes, your voice. You get hands-on training and walk away confident.',
    highlights: [
      "Set up in 1-2 sessions — no tech skills needed",
      'Works inside GPT Codex (simple interface, no tech skills needed)',
    ...
    techDetails: [
      'GPT Codex subscription setup + configuration',
  ...
  const assistantData = {
    ...
    description: 'A dedicated AI assistant that lives on your phone, answers customers, manages your inbox, handles scheduling — and never sleeps. Works through WhatsApp, Telegram, or Discord.',
    highlights: [
      'We build it, you use it — no tech skills on your end',
      'Runs 24/7 through WhatsApp, Telegram, or Discord',
    ...
    techDetails: [
      ...
      'AI model: GPT Codex, optimized for your use case',
    ...
    costs: {
      basic: { label: 'Basic Use', monthly: '~$30–$50/mo', items: ['VPS hosting: ~$7–$15/mo', 'OpenAI API: ~$20/mo USD'] },
      advanced: { label: 'Advanced Use', monthly: '~$80–$160/mo', items: ['VPS hosting: ~$15–$25/mo', 'OpenAI Pro: $200/mo USD', 'Optional integrations'] },
                ...
                <ScrollReveal key={feat.title} delay={i * 0.07}>
                  ...
                  >
                    <div className="w-12 h-12 rounded-xl bg-copper/15 flex items-center justify-center shrink-0 group-hover:bg-copper/25 transition-colors duration-300">
                      <Icon size={22} weight={feat.weight} className="text-copper" />
                    </div>
                    <div>
